        ...
        <div className="relative" style={{ perspective: "2000px" }}>
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute top-20 left-10 p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl hidden md:block"
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-white">Funds Delivered</p>
                </div>
              </div>
            ...
            <motion.div 
              ...
              className="absolute bottom-20 right-10 p-6 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl shadow-2xl hidden md:block"
            >
