    ...
    <section id="impact" className="py-32 px-6 overflow-hidden bg-black">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          <h2 className="text-4xl font-display font-bold tracking-tight mb-4">Voices of Impact</h2>
        ...
        <div className="flex gap-6 animate-scroll hover:pause">
          {[...testimonials, ...testimonials].map((t, i) => (
            <motion.div
              ...
              className="flex-shrink-0 w-[400px] p-8 glass rounded-[2.5rem] relative group transition-all duration-500 hover:border-orange-500/20"
            >
