  ...
  return (
    <section className="py-40 px-6 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          <h2 className="text-6xl md:text-8xl font-display font-black tracking-tighter mb-8 leading-[0.9]">
            Be the Change <br />
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto px-12 py-6 rounded-2xl bg-orange-600 text-white font-bold text-xl hover:scale-105 transition-all shadow-2xl shadow-orange-600/20">
              Create Your Account
            </button>
            <button className="w-full sm:w-auto px-12 py-6 rounded-2xl glass font-bold text-xl hover:bg-white/10 transition-all">
              Explore Campaigns
            </button>
          </div>
        </motion.div>
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-20">
          <div className="col-span-2 lg:col-span-1">
            <div className="text-2xl font-display font-black tracking-tighter mb-6 flex items-center gap-2.5">
              ...
              <span className="text-white">AidUp</span>
            </div>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="relative">
              <input 
                ...
                className="w-full px-4 py-3 rounded-xl bg-white/5 border border-white/10 text-sm focus:outline-none focus:ring-1 focus:ring-orange-500/40 transition-all"
              />
