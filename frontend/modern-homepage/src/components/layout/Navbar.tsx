...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      >
        <Link href="/" className="text-xl font-display font-extrabold tracking-tighter flex items-center gap-2.5 group">
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="px-6 py-2 rounded-full bg-orange-600 text-white text-sm font-bold hover:bg-orange-500 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-orange-600/20">
            Join AidUp
          </button>
        </div>
      </nav>
