...
const campainRoutes = require('./routes/campainRoutes');
const organizorRoutes = require('./routes/organizorRoutes');
const adminRoutes = require('./routes/adminRoutes');
const donatorRoutes = require('./routes/donatorRoutes');
const donationRoutes = require('./routes/donationRoutes');
const publicCampainRoutes = require('./public/publiccampains');
const publicOrganizorRoutes = require('./public/publicorganizer');
const publicDonatorRoutes = require('./public/publicdonator');
...
// Mount Campain routes
app.use('/campain', campainRoutes)
app.use('/publicca', publicCampainRoutes)   

//organizer routes
app.use('/organizor',organizorRoutes)
app.use('/publicor', publicOrganizorRoutes)
...
app.use('/publicdo', publicDonatorRoutes)
