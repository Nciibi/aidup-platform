...
router.post('/register',(req, res, next) => {
    upload.fields([{ name: 'image', maxCount: 1 }, { name: 'photo', maxCount: 1 }])(req, res, (err) => {
...
},processImage,uploadErrorHandler,
...
router.post('/verify-registration-email', verifyEmailCode);
